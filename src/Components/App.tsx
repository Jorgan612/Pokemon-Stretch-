    ...
    return (
      <div className="App">
        ...
        <>
          ...
          <Nav/>
          <Routes>
            <Route path='/' element={<GenerationContainer genInfo={this.state.generations} allPoke={this.state.pokemon}/>} />
            <Route path='/all-pokemon' element={<PokeContainer pokemon={this.state.pokemon} />} />
